...
data_train_val = np.loadtxt('mnist/mnist_train.amat')
data_test = np.loadtxt('mnist/mnist_test.amat')
...
data_train_val = np.loadtxt('mnist_rotation_new/mnist_all_rotation_normalized_float_train_valid.amat')
data_test = np.loadtxt('mnist_rotation_new/mnist_all_rotation_normalized_float_test.amat')
